...
public class UserServiceImpl implements IUserService {
	...
	private void sendActiceEmail(Users user) throws MessagingException, UnsupportedEncodingException {
		...
		String content = "Dear [[name]],<br>"
				...
				+ "community guidelines. As a result, your account has been suspended</div><br>"
				...
				+ "Please contact us on our <a href=\"https://www.facebook.com/docsharevn\">Facebook DocShare</a> if you have any further questions or concerns.<br>"
